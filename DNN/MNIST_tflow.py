...
def deepnn(x):
	...
	with tf.name_scope('conv1'):
		W_conv1 = weight_variable([5, 5, 1, 10]) # 5x5 kernel, 1 input 32 output channels
	...
	with tf.name_scope('conv2_dropout'):
	...
	# is down to 4x4x20 feature maps -- maps this to 50 features.
	...
	# Map the 50 features to 10 classes, one for each digit
